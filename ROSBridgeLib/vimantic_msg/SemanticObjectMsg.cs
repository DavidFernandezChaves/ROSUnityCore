    ...
    namespace ROSBridgeLib {
        namespace ViMantic_msgs {
            ...
            public class SemanticObjectMsg : ROSBridgeMsg {
                ...
                public SemanticObjectMsg(ObjectHypothesisWithPoseMsg object1, String objectType, String roomId, String roomType, Vector3Msg size) {
                    _object = object1;
                ...
                public override string ToString() {
                    return "SemanticObject [object=" + _object.ToString() + ", objectType=" + _objectType + ", roomId=" + _roomId + ", roomType=" + _roomType + ", size=" + _size.ToString() + "]";
                }

                public override string ToYAMLString() {
                    return "{\"object\" : " + _object.ToYAMLString() + ", \"objectType\" : \"" + _objectType + "\", \"roomId\" : \"" + _roomId + "\", \"roomType\" : \"" + _roomType + "\", \"size\" : " + _size.ToYAMLString() + "}";
                }
            }
        }
    }
